...
Pod::Spec.new do |s|
  ...
  s.version      = "0.0.1"
  s.summary      = "汉字拼音排序的通讯录库"

  s.description  = <<-DESC
                   A longer description of ChineseAddressbook in Markdown format.
  ...
  s.source_files  = "ChineseAddressbook/", "ChineseAddressbook/Addressbook/*.{h,m}"
